...
public class Vector<E> {
  ...
  /**
   * Increments the size of the vector and adds a new element at the end of the vector.
   * @param e element to be inserted
   */
  public void add(E e) {
    add(length, e);
  ...
  /**
   * Removes the element at the given index from the vector and decrements its size.
